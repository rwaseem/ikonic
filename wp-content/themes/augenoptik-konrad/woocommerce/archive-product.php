...
<div class="shop-prodsidebar">
    <div class="row">
		<div class="col-lg-4 col-md-4 col-sm-12 shopmain-col">
            <div class="shopmain-sidebar">
                <?php
                /**
        ...
        <div class="col-lg-8 col-md-8 col-sm-12 shopmain-col">
            <?php
